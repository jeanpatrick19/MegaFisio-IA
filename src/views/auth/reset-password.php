<div class="auth-container">
    <div class="auth-card">
        <div class="auth-header">
            ...
            <p>Olá, <strong><?= htmlspecialchars($user['name']) ?></strong>! Defina sua nova senha</p>
        </div>
        ...
        <div class="alert alert-info">
            ...
            <div>
                <strong>Link de recuperação válido</strong><br>
                Você pode redefinir sua senha agora. Por segurança, este link expira em breve.
            </div>
        </div>
        
        <form class="auth-form" method="POST" action="<?= BASE_URL ?>/reset-password?token=<?= htmlspecialchars($token) ?>">
        ...
        <div class="auth-footer">
            <p class="security-notice">
                ...
                Após redefinir, você será redirecionado para a tela de login
            </p>
        </div>
    </div>
</div>
